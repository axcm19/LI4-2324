...

{
    public class Leilao
    {
        ...
        public float valor_minimo_liitacao { get; set; }
        ...
        public Leilao(int id, string categoria, string nome, DateTime di, DateTime df, float preco_base, float min_lic, float lic_atual, bool apro, Dictionary<string, Licitacao> licitacoes, LoteArtigos lote_artigos)
        {
            id_leilao = id;
        ...
        public Leilao(Leilao l)
        {
            ...
            valor_minimo_liitacao = l.valor_minimo_liitacao;
